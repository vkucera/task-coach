...
version = os.environ.get('TCVERSION', '0.74.2')
tskversion = 25 # Current version number of the task file format
release_day = '25' # Day number of the release, 1-31, as string
