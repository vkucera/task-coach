...
'''        <H3>Download %(name)s (release %(version)s)</H3>
        ...
        <p>There are two sets of packages: one set from Trunk with the new
        features and one set from the latest Release branch with bug fixes. 
        If you don't know what that means, you probably shouldn't download 
        these:</p>
        <ul>
        <li><a href="http://www.fraca7.net/TaskCoach-packages/latest_bugfixes.py">Latest bug fixes</a></li>
        <li><a href="http://www.fraca7.net/TaskCoach-packages/latest_features.py">Latest new features</a></li>
        </ul>
...
'''        <H3>Portable %(name)s</H3>
        ...
        <img src="PortableApps.jpg" alt="PortableApps"></a>
        </p>
        <hr>
        <p>
        <a href="http://www.winpenpack.com/main/download.php?view.1258">
        <img src="winPenPack.jpg" alt="winPenPack"></a>
        </p>
'''
...
pages['iPhone'] = '''<H3>iPhone and iPod Touch</H3>
...
pages['iPhone_fr'] = u'''<H3>iPhone et iPod Touch</H3>
        <P>Il existe une application iPhone et iPod Touch qui est capable de se
